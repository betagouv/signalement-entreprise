...
class EtablissementTable(tag: Tag) extends Table[EtablissementData](tag, "etablissements") {
  ...
  def ancienneDenominationUsuelleEtablissement = column[Option[String]]("anciennedenominationusuelleetablissement")
  ...
  def constructEtablissement(etablissement: EtablissementHList): EtablissementData = etablissement match {
    case id ::
        ...
        ancienneDenominationUsuelleEtablissement ::
      ...
      EtablissementData(
        ...
        ancienneDenominationUsuelleEtablissement = ancienneDenominationUsuelleEtablissement,
  ...
  def extractEtablissement(etablissement: EtablissementData): Option[EtablissementHList] =
    Some(
      etablissement.id ::
        ...
        etablissement.ancienneDenominationUsuelleEtablissement ::
